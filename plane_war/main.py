...
from plane_war import myplane
from plane_war import enemy
from plane_war import bullet
from plane_war import supply
import random
    ...
    while running:
        for event in pygame.event.get():
            ...
            # 鼠标事件
                ...
                # event.button == 1按下鼠标左键;paused_rect.collidepoint(event.pos)检测鼠标是否在矩形之内
